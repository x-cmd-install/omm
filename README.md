...
[![x-cmd/install — omm Code Quality Monitoring Repo Card](https://x-cmd.com/repo-card/omm.svg)](https://x-cmd.com/install/omm)
...
Total: **5,269** lines of code across **80** files in the top 5 languages.
...
| Toml | 79 | 0 | 16 | 1 |
| Yaml | 7 | 1 | 0 | 1 |
| Markdown | 0 | 677 | 273 | 30 |

## Source

- **Upstream**: <https://github.com/dhth/omm>
- **Homepage**: <https://tools.dhruvs.space/omm>
- **License**: MIT

## Release

- **Latest**: `v0.7.0` (2026-03-06)
- **Last commit**: 2026-09-20
- **Assets in release**: 7

## Popularity

- **Stars**: 333 · **Forks**: 4 · **Open issues**: 21 · **Contributors**: 1

## Totals (cumulative)

- **Releases**: 14 · **Merged PRs**: 98 · **Open PRs**: 2 · **Closed issues**: 12 · **Open issues**: 9 · **Commits**: 147
...
| last60d | 2026-07-26 | 0 | 10 | 0 | 0 | 1 | 14 |
| 90d | 2026-06-26 | 0 | 10 | 0 | 0 | 1 | 14 |
| last180d | 2026-03-28 | 0 | 26 | 1 | 0 | 1 | 32 |
| 360d | 2025-09-29 | 1 | 54 | 1 | 0 | 4 | 63 |
| last720d | 2024-10-04 | 2 | 85 | 2 | 2 | 9 | 102 |
...
Install metadata for omm lives in the [x-cmd/install](https://github.com/x-cmd/install) index — a curated YAML package list that x-cmd consumes at install time. If `omm` is missing, out of date, or installs incorrectly, please open an issue or PR there:

- **Open an issue**: <https://github.com/x-cmd/install/issues/new>
- **Edit the package entry**: <https://github.com/x-cmd/install/edit/main/omm.yml> (or whichever path the index uses)

The data on this page (card / loc / scorecard / release) is auto-collected by [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) and is regenerated daily. Improvements to *install behaviour* (which version gets installed, platform-specific quirks, dependencies) belong upstream in the index.

_Snapshot: `data/card/260924.yml` · 2026-09-24T04:54:51Z._
